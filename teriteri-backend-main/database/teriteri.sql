...
CREATE TABLE `video` (
                         ...
                         PRIMARY KEY (`aid`),
                         UNIQUE KEY `vid` (`aid`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='文章表'; #表的注释
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_video` (
                              `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
                              `vid` int(11) NOT NULL COMMENT '阅览文章的用户UID',
                              `aid` int(11) NOT NULL COMMENT '文章ID',
                              `play` int(11) NOT NULL DEFAULT '0' COMMENT '阅读次数',
                              `love` tinyint(4) NOT NULL DEFAULT '0' COMMENT '点赞 0没赞 1已点赞',
                              `unlove` tinyint(4) NOT NULL DEFAULT '0' COMMENT '不喜欢 0没点 1已不喜欢',
                              `coin` tinyint(4) NOT NULL DEFAULT '0' COMMENT '投币数 0-2 默认0',
                              `collect` tinyint(4) NOT NULL DEFAULT '0' COMMENT '收藏 0没收藏 1已收藏',
                              `play_time` datetime NOT NULL COMMENT '最近阅读时间',
                              `love_time` datetime DEFAULT NULL COMMENT '点赞时间',
                              `coin_time` datetime DEFAULT NULL COMMENT '投币时间',
                              PRIMARY KEY (`id`),
                              UNIQUE KEY `id` (`id`),
                              UNIQUE KEY `uid_vid__index` (`aid`,`vid`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb4 COMMENT='用户文章关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `article_stats` (
                               `aid` int(11) NOT NULL COMMENT '文章ID',
                               `play` int(11) NOT NULL DEFAULT '0' COMMENT '阅读',
                               `danmu` int(11) NOT NULL DEFAULT '0' COMMENT '弹幕数',
                               `good` int(11) NOT NULL DEFAULT '0' COMMENT '点赞数',
                               `bad` int(11) NOT NULL DEFAULT '0' COMMENT '点踩数',
                               `coin` int(11) NOT NULL DEFAULT '0' COMMENT '投币数',
                               ...
                               PRIMARY KEY (`aid`),
                               UNIQUE KEY `vid` (`aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='文章 数据统计表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `follow` (
                                 #`uid` int(11) NOT NULL COMMENT '用户ID',
                                 `uid_follow` int(11) NOT NULL COMMENT '关注的人',
                                 `uid_fans` int(11) NOT NULL COMMENT '粉丝',
                                 `visible` int(1) not null comment '是否可见',
                                 PRIMARY KEY (`uid_follow`,`uid_fans`)
                                 #UNIQUE KEY `vid` (`uid`)
